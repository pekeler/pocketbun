...
Upstream source: [/docs/how-to-use](https://pocketbase.io/docs/how-to-use/)
...
Upstream source: [/docs/collections](https://pocketbase.io/docs/collections/)
...
`
created >= '2024-11-19 00:00:00.000Z' && created
...
Upstream source: [/docs/api-rules-and-filters](https://pocketbase.io/docs/api-rules-and-filters/)
...
Upstream source: [/docs/authentication](https://pocketbase.io/docs/authentication/)

### Source Fragment: `authentication/+page.svelte`
...
*
(you have access to `` and `` placeholders)
*.
...
*Dashboard > Collections > _superusers >  > "Impersonate" dropdown option
:
...
### Source Fragment: `authentication/OAuth2.svelte`
...
enable and configure the provider from your PocketBase auth collection options (*PocketBase > Collections >

> Edit collection (settings cogwheel) > Options
> OAuth2
).

(activeTab = TAB_ALL_IN_ONE)}
>
All in one (*recommended*)

(activeTab = TAB_MANUAL_CODE)}
>
...
Upstream source: [/docs/files-handling](https://pocketbase.io/docs/files-handling/)
...
Upstream source: [/docs/working-with-relations](https://pocketbase.io/docs/working-with-relations/)
...
Upstream source: [/docs/use-as-framework](https://pocketbase.io/docs/use-as-framework/)
...
For further info, please check the related
Extend with Go
or
