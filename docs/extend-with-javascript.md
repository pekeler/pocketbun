...
benchmarks
). You can adjust the pool size manually with the `--hooksPool=50` flag (*increasing the pool size may improve the performance in high concurrent scenarios but also will
...
Upstream source: [/docs/js-event-hooks](https://pocketbase.io/docs/js-event-hooks/)

### Source Fragment: `js-event-hooks/+page.svelte`
...
### Source Fragment: `event_hooks.js`
...
Upstream source: [/docs/js-routing](https://pocketbase.io/docs/js-routing/)
...
You can also use `` format to specify a parameter that targets more than one path
segment.
...
### Source Fragment: `js-database/+page.svelte`
...
### Source Fragment: `TransactionInfoJS.svelte`
...
Upstream source: [/docs/js-records](https://pocketbase.io/docs/js-records/)

### Source Fragment: `js-records/+page.svelte`
...
Upstream source: [/docs/js-collections](https://pocketbase.io/docs/js-collections/)

### Source Fragment: `js-collections/+page.svelte`
...
Upstream source: [/docs/js-migrations](https://pocketbase.io/docs/js-migrations/)
...
Upstream source: [/docs/js-jobs-scheduling](https://pocketbase.io/docs/js-jobs-scheduling/)
...
Upstream source: [/docs/js-sending-emails](https://pocketbase.io/docs/js-sending-emails/)
...
Upstream source: [/docs/js-rendering-templates](https://pocketbase.io/docs/js-rendering-templates/)
...
Upstream source: [/docs/js-console-commands](https://pocketbase.io/docs/js-console-commands/)
...
Upstream source: [/docs/js-sending-http-requests](https://pocketbase.io/docs/js-sending-http-requests/)
...
Upstream source: [/docs/js-realtime](https://pocketbase.io/docs/js-realtime/)

By default PocketBase sends realtime events only for Record create/update/delete operations (*and for the OAuth2 auth redirect
...
Upstream source: [/docs/js-logging](https://pocketbase.io/docs/js-logging/)

### Source Fragment: `js-logging/+page.svelte`
...
### Source Fragment: `go-logging/LogsWriteAlert.svelte`
...
### Source Fragment: `go-logging/LogsSettingsSection.svelte`
