...
describe("url field", () => {
  it("base methods", () => {
    testFieldBaseMethods(FieldTypeURL);
  });
      ...
      const scenarios = [
        {
          ...
          field: Object.assign(new URLField(), { Name: "test" }),
          record: () => {
        ...
        },
        {
          ...
          field: Object.assign(new URLField(), { Name: "test", Required: true }),
          record: () => {
            const record = NewRecord(collection);
            record.SetRaw("test", "");
            return record;
        ...
        },
        {
          ...
          field: Object.assign(new URLField(), {
            Name: "test",
  ...
  it("validate settings", async () => {
    ...
    try {
      ...
      const scenarios = [
        {
          name: "zero minimal",
          build: () => Object.assign(new URLField(), { Id: "test", Name: "test" }),
          expectErrors: [],
        },
        {
          name: "both onlyDomains and exceptDomains",
          build: () =>
            Object.assign(new URLField(), {
              Id: "test",
              Name: "test",
