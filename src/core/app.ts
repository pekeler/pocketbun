...
export interface App {
  ...
  AuxSaveWithContextSync(ctx: unknown, model: Model): Error | null;
  AuxSaveNoValidateWithContextSync(ctx: unknown, model: Model): Error | null;
  ...
  AuxDelete(model: Model): Promise<Error | null>;
  AuxDeleteWithContext(ctx: unknown, model: Model): Promise<Error | null>;
  AuxDeleteSync(model: Model): Error | null;
  AuxDeleteWithContextSync(ctx: unknown, model: Model): Error | null;
  ...
  cron: App["Cron"];
  isDev: App["IsDev"];
  subscriptionsBroker: App["SubscriptionsBroker"];
  logger: App["Logger"];
  modelQuery: App["ModelQuery"];
  auxModelQuery: App["AuxModelQuery"];
  collectionQuery: App["CollectionQuery"];
  logQuery: App["LogQuery"];
  findLogById: App["FindLogById"];
  logsStats: App["LogsStats"];
  deleteOldLogs: App["DeleteOldLogs"];
  txInfo: App["TxInfo"];
  newMailClient: App["NewMailClient"];
  newFilesystem: App["NewFilesystem"];
  newFilesystemAsync: NonNullable<App["NewFilesystemAsync"]>;
  newBackupsFilesystem: App["NewBackupsFilesystem"];
  newBackupsFilesystemAsync: NonNullable<App["NewBackupsFilesystemAsync"]>;
  createBackup: App["CreateBackup"];
  restoreBackup: App["RestoreBackup"];
  restart: App["Restart"];
  restartAsync: NonNullable<App["RestartAsync"]>;
  save: App["Save"];
  saveNoValidate: App["SaveNoValidate"];
  saveWithContext: App["SaveWithContext"];
  saveNoValidateWithContext: App["SaveNoValidateWithContext"];
  saveSync: App["SaveSync"];
  saveNoValidateSync: App["SaveNoValidateSync"];
  saveWithContextSync: App["SaveWithContextSync"];
  saveNoValidateWithContextSync: App["SaveNoValidateWithContextSync"];
  auxSave: App["AuxSave"];
  auxSaveNoValidate: App["AuxSaveNoValidate"];
  auxSaveWithContext: App["AuxSaveWithContext"];
  auxSaveNoValidateWithContext: App["AuxSaveNoValidateWithContext"];
  auxSaveSync: App["AuxSaveSync"];
  auxSaveNoValidateSync: App["AuxSaveNoValidateSync"];
  auxSaveWithContextSync: App["AuxSaveWithContextSync"];
  auxSaveNoValidateWithContextSync: App["AuxSaveNoValidateWithContextSync"];
  delete: App["Delete"];
  deleteWithContext: App["DeleteWithContext"];
  deleteSync: App["DeleteSync"];
  deleteWithContextSync: App["DeleteWithContextSync"];
  auxDelete: App["AuxDelete"];
  auxDeleteWithContext: App["AuxDeleteWithContext"];
  auxDeleteSync: App["AuxDeleteSync"];
  auxDeleteWithContextSync: App["AuxDeleteWithContextSync"];
  validate: App["Validate"];
  validateWithContext: App["ValidateWithContext"];
  validateSync: App["ValidateSync"];
  runInTransaction: App["RunInTransaction"];
  runInTransactionSync: App["RunInTransactionSync"];
  runInTransactionAsync: App["RunInTransactionAsync"];
  auxRunInTransaction: App["AuxRunInTransaction"];
  auxRunInTransactionSync: App["AuxRunInTransactionSync"];
  isTransactional: App["IsTransactional"];
  unsafeWithoutHooks: App["UnsafeWithoutHooks"];
  recordQuery: App["RecordQuery"];
  findAllCollections: App["FindAllCollections"];
  reloadCachedCollections: App["ReloadCachedCollections"];
  findCachedCollectionByNameOrId: App["FindCachedCollectionByNameOrId"];
  findCollectionReferences: App["FindCollectionReferences"];
  findCachedCollectionReferences: App["FindCachedCollectionReferences"];
  hasTable: App["HasTable"];
  findRecordByViewFile: App["FindRecordByViewFile"];
  findRecordsByIds: App["FindRecordsByIds"];
  findAllRecords: App["FindAllRecords"];
  findFirstRecordByData: App["FindFirstRecordByData"];
  findRecordsByFilter: App["FindRecordsByFilter"];
  countRecords: App["CountRecords"];
  expandRecord: App["ExpandRecord"];
  expandRecords: App["ExpandRecords"];
  canAccessRecord: App["CanAccessRecord"];
  findAuthRecordByEmail: App["FindAuthRecordByEmail"];
  findAllExternalAuthsByRecord: App["FindAllExternalAuthsByRecord"];
  findAllExternalAuthsByCollection: App["FindAllExternalAuthsByCollection"];
  findFirstExternalAuthByExpr: App["FindFirstExternalAuthByExpr"];
  deleteAllExternalAuthsByRecord: App["DeleteAllExternalAuthsByRecord"];
  findAllOTPsByRecord: App["FindAllOTPsByRecord"];
  findAllOTPsByCollection: App["FindAllOTPsByCollection"];
  findOTPById: App["FindOTPById"];
  deleteAllOTPsByRecord: App["DeleteAllOTPsByRecord"];
  deleteExpiredOTPs: App["DeleteExpiredOTPs"];
  findAllMFAsByRecord: App["FindAllMFAsByRecord"];
  findAllMFAsByCollection: App["FindAllMFAsByCollection"];
  findMFAById: App["FindMFAById"];
  deleteAllMFAsByRecord: App["DeleteAllMFAsByRecord"];
  deleteExpiredMFAs: App["DeleteExpiredMFAs"];
  findAllAuthOriginsByRecord: App["FindAllAuthOriginsByRecord"];
  findAllAuthOriginsByCollection: App["FindAllAuthOriginsByCollection"];
  findAuthOriginById: App["FindAuthOriginById"];
  findAuthOriginByRecordAndFingerprint: App["FindAuthOriginByRecordAndFingerprint"];
  deleteAllAuthOriginsByRecord: App["DeleteAllAuthOriginsByRecord"];
  truncateCollection: App["TruncateCollection"];
  importCollectionsByMarshaledJSON: App["ImportCollectionsByMarshaledJSON"];
  importCollectionsByMarshaledJSONSync: App["ImportCollectionsByMarshaledJSONSync"];
  importCollections: App["ImportCollections"];
  importCollectionsSync: App["ImportCollectionsSync"];
  syncRecordTableSchema: App["SyncRecordTableSchema"];
  syncRecordTableSchemaSync: App["SyncRecordTableSchemaSync"];
  deleteView: App["DeleteView"];
  saveView: App["SaveView"];
  saveViewSync: App["SaveViewSync"];
  createViewFields: App["CreateViewFields"];
  createViewFieldsSync: App["CreateViewFieldsSync"];
  dryRunView: App["DryRunView"];
  tableInfo: App["TableInfo"];
  tableColumns: App["TableColumns"];
  tableIndexes: App["TableIndexes"];
  deleteTable: App["DeleteTable"];
  vacuum: App["Vacuum"];
  auxVacuum: App["AuxVacuum"];
  isCollectionNameUnique: App["IsCollectionNameUnique"];
}
