    ...
    try {
      ...
      const scenarios = [
        ...
        },
        {
          ...
          allowHiddenFields: false,
          expectQuery:
            "SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo3` `demo4_rel_one_cascade` ON [[demo4_rel_one_cascade.id]] = [[demo4.rel_one_cascade]] WHERE ((([[demo4_rel_one_cascade.id]] = '' OR [[demo4_rel_one_cascade.id]] IS NULL) OR ({:TEST} IS NOT '' AND {:TEST} IS NOT {:TEST}))) AND ([[demo4_rel_one_cascade.created]] > 1)",
        },
        {
        ...
        },
        {
          ...
          allowHiddenFields: false,
          expectQuery:
            "SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN `demo3` `demo4_self_rel_one_rel_one_cascade` ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE ((([[demo4_self_rel_one_rel_one_cascade.id]] = '' OR [[demo4_self_rel_one_rel_one_cascade.id]] IS NULL) OR ({:TEST} IS NOT '' AND {:TEST} IS NOT {:TEST}))) AND ([[demo4_self_rel_one_rel_one_cascade.created]] > 1)",
        },
        {
          ...
          allowHiddenFields: false,
          expectQuery:
            "SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo4` `demo4_self_rel_one` ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN `demo3` `demo4_self_rel_one_rel_one_cascade` ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE ((([[demo4_self_rel_one_rel_one_cascade.id]] = '' OR [[demo4_self_rel_one_rel_one_cascade.id]] IS NULL) OR ({:TEST} IS NOT '' AND {:TEST} IS NOT {:TEST}))) AND (([[demo4_self_rel_one_rel_one_cascade.created]] > 1 AND [[demo4_self_rel_one_rel_one_cascade.updated]] > 1))",
        },
        {
        ...
        },
        {
          ...
          allowHiddenFields: false,
          expectQuery:
            "SELECT DISTINCT `demo4`.* FROM `demo4` LEFT JOIN `demo3` `__collection_demo3` WHERE ((([[__collection_demo3.id]] = '' OR [[__collection_demo3.id]] IS NULL) OR ({:TEST} IS NOT '' AND {:TEST} IS NOT {:TEST}))) AND (((([[__collection_demo3.title]] > 1) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo3.title]] as [[multiMatchValue]] FROM `demo4` `__mm_demo4` LEFT JOIN `demo3` `__mm___collection_demo3` WHERE [[__mm_demo4.id]] = [[demo4.id]]) {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > 1))))))",
        },
        {
