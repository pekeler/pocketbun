...
- Record create/update hot paths now avoid some unnecessary hook-bridge work and duplicate request-body parsing, reducing measured write overhead on common JSON CRUD requests.
