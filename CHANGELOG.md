...
- Create-heavy API requests now skip disabled activity-logging work earlier and do less route path parsing overhead, trimming measured request-layer cost on local write benchmarks.
