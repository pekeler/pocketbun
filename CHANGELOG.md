...
- Backups now use disk-backed SQLite snapshots, keeping archives consistent while clustered writes and WAL checkpoints continue without loading entire databases into memory.
