...
- Record create/update hot paths now avoid some unnecessary hook-bridge work, duplicate request-body parsing, unstable rule-query placeholder generation, and extra internal Date/route matching churn, reducing measured write overhead on common JSON CRUD requests and improving rule-heavy create benchmarks.
