...
- Fixed remaining cross-platform CI flakes by preferring fresh-request body clones in multipart fallback parsing, loosening uploaded-file detection to accept Bun file-like values across runtimes, retrying sync HTTP helper subprocess parsing up to 3 attempts, and relaxing a tight JSVM sleep timing assertion for slower macOS runners.
