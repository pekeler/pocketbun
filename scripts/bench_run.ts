// PocketBun-only: local benchmark runner for quick performance smoke checks.
...
const serverProc = Bun.spawn({
  cmd: ["bun", "run", "scripts/bench_server.ts"],
  env: {
    ...process.env,
...
try {
  ...
  console.log(`\nPocketBun local benchmark (concurrency=${concurrency}, duration=${durationMs}ms)`);
